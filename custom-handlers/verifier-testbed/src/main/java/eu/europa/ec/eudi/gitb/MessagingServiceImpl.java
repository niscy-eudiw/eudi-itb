...
public class MessagingServiceImpl implements MessagingService {
   ...
   *
   * <p>This is the point where input is received for the call that this service needs to translate
   * into an actual communication. This communication would be specific to a communication protocol
   * or a separate system's API.
   *
   * <p>The result of the operation is typically an empty success or failure report depending on
   * whether or not the communication was successful. This report could however include additional
   * information that would be reported back to the test bed.
   *
